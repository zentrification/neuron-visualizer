class SynapsesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @synapse.save
        format.html { redirect_to @synapse, notice: 'Synapse was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @synapse.update_attributes(params[:synapse])
        format.html { redirect_to @synapse, notice: 'Synapse was successfully updated.' }
        format.json { head :ok }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to synapses_url }
      format.json { head :ok }
    end
  end
end
